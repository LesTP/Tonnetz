...
export const LIBRARY: readonly LibraryEntry[] = [
  ...
  },
  {
    ...
    tempo: 190,
    chords: ["C", "C", "F", "C", "C", "C", "G", "G", "C", "C", "G", "C", "Am", "G", "C", "C"],
  },
  {
    id: "ii-v-i",
    title: "Autumn Leaves",
    ...
    comment:
      "The most common chord progression in jazz, a cadential succession whose roots descend in fifths from the supertonic to the dominant to the tonic. The iim7–V7–Imaj7 voicing provides smooth voice leading: the third of one chord becomes the seventh of the next, and the seventh falls a half-step to become the third. Ubiquitous in jazz, ii-V-I harmonic movement shows on Tonnetz as a straight horizontal line. Autumn Leaves runs through it once in Bb major, then again in the relative minor (Gm).<br><br><b>Other examples:</b><ul><li>\"Honeysuckle Rose\" (1928)</li><li>\"Satin Doll\" (Duke Ellington)</li><li>\"If I Fell\" (The Beatles)</li><li>Bach — Well-Tempered Clavier, Book I, Prelude I, opening: I–ii–V–I</li></ul>",
    tempo: 120,
    chords: ["Cm7", "F7", "Bbmaj7", "Ebmaj7", "Am7b5", "D7", "Gm6", "Gm6"],
  },
  {
    id: "neapolitan-sixth",
    title: "Because",
  ...
  },
  {
    ...
    chords: [
      "Am", "Am", "G", "G", "Am", "Am", "E", "E",
      "Am", "Am", "G", "Em", "Am", "E7", "Am", "Am",
      "C", "C", "G", "G", "Am", "Am", "E", "E",
      "C", "C", "G", "Em", "Am", "E7", "Am", "Am",
    ],
  },
  {
  ...
  },
  {
    ...
    comment:
      "Variations of the I-V-vi-IV loop are common across several genres. When starting on I, it is known as the \"Axis of Awesome progression\" after the comedy band that played a medley of 36 songs using these four chords. A version starting on the minor sixth chord, vi-IV-I-V variation was dubbed the \"sensitive female chord progression\" for being prominent in the music of the Lilith Fair festival.",
    tempo: 120,
    chords: ["C", "G", "Am", "F6", "C", "G", "F", "C"],
  },
  {
